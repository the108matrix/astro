...
userNumCopper = placeholder_c.number_input('Revenu fiscal de reference 2023 (sur les revenus 2022) en euros: ', min_value= 0, value=100000,step=1.,format="%.2f")
userNumSilver = placeholder_s.number_input('Nombre de parts ', min_value= 1, step=1.,format="%.2f")
