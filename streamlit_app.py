...
# Calculate the center of the map based on filtered data
    ...
    fig = px.scatter_mapbox(filtered_df, lat="latitude", lon="longitude", color="Color", color_discrete_map=color_palette,
                            size="Magnitude", zoom=4, height=600, width=1000,hover_name="Date",hover_data=["Magnitude"],
    ...
    fig_bar = px.bar(magnitude_df, x='Magnitude Range', y='Count', text='Count', color='Count',height=600, width=1000)
